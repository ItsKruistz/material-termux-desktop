...
```
termux-setup-storage && apt update && apt upgrade -y && apt install wget && termux-wake-lock && wget https://raw.githubusercontent.com/ItsKruistz/material-termux-desktop/main/install && chmod +x install && ./install
```
